...
│   ├── loss_and_metrics.py        # Loss functions (Weighted CE) and metrics (Dice, IoU)
│   ├── preprocess_data.py         # Data preprocessing pipeline
│   └── dataset_introduction.ipynb # Dataset visualization and exploration
├── training/
...
- Image size: 512×512×N (variable depth)
...
2. **Preprocess 3D volumes into 2D slices**:
   ...
   - Generates augmented variations (4 brightness variations × 4 rotations)
...
Total loss: `loss = loss_ce1 + α × loss_ce2` (α=10, σ=3)
...
1. **Data Augmentation**:
   ...
   - 16× data augmentation per slice
...
- **Image Size**: Resized to 256×256 for computational efficiency. Can be adjusted in preprocessing.
